...
INSERT INTO book (title, isbn, description, published_date, cover_art, series_id, genre_id, date_created)
VALUES ('The Fellowship of the Ring', '9780547928210', 'The beginning of a great adventure!', '07/29/1954', 'https://images-na.ssl-images-amazon.com/images/I/41gHG-a2OEL._SX331_BO1,204,203,200_.jpg', 1, 2, '2001-02-12' ),
		('The Two Towers', '9780547928203', 'The middle of a great adventure!', '11/11/1954', 'https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcQRVeocJMduZrDIU2VmU5_i_TW8TGKLaMZ0LFckBxFFzJMdBy56', 1, 2, '2020-06-06'),
		('The Return of the King', '9780547928210', 'The end of a great adventure!', '10/20/1955', 'https://i.harperapps.com/hcanz/covers/9780261103597/x293.jpg',1, 2, '1999-07-04'),
		('The Eye of the World', '9780312850098', 'The start of an Epic adventure!', '01/15/1990', 'https://images-na.ssl-images-amazon.com/images/I/81tBoQP5V+L.jpg', 2, 2, '2016-12-25'),
		('A Memory of Light', '9780765325952', 'The end of an Epic adventure!', '01/08/2013', 'https://images-na.ssl-images-amazon.com/images/I/81DcFQRTuOL.jpg', 2, 2, '2022-01-01'),
		('Mort', '9780062225719', 'Mort gets an offer he can not refuse.', '11/12/1987', 'https://m.media-amazon.com/images/I/41RwpLn8FuL.jpg', 3, 2, '2021-02-12' ),
		('The Name of the Wind', '9780756404741', 'The tale of Kvothe begins.','03/27/2007', 'https://images-na.ssl-images-amazon.com/images/I/91b8oNwaV1L.jpg', 4, 2, '2015-11-27'),
		('The Wise man''s Fear', '9780756407919', 'The tale of Kvothe continues!', '03/01/2011', 'https://m.media-amazon.com/images/I/51qKDJ8lPeL.jpg', 4, 2, '2021-05-16'),
		('A Game of Thrones', '9780553381689', 'When you play the game of thrones, you win or you die. There is no middle ground.', '08/01/1996', 'https://images-na.ssl-images-amazon.com/images/I/914uNuOXwSL.jpg', 5, 2, '2022-05-08'),
		('A Dance with Dragons', '9780553582017', 'Spoiler: Pretty much everyone dies', '07/12/2011', 'https://images-na.ssl-images-amazon.com/images/I/81e1rZDeBBL.jpg', 5, 2, '2007-11-12'),
		('The Left Hand of Darkness', '9780441478125', 'Open yourself to Winter', '03/01/1969', 'https://images-na.ssl-images-amazon.com/images/I/81EtwGcbbpL.jpg', 6, 1, '2010-02-16');
